import {startController} from './bridge.js?v=playlist116';
const status=document.querySelector('#connection');
status.textContent='Loading browser engine…';
try{await startController();await import('./panel.js?v=playlist116');await import('./pair-controller.js?v=playlist116');await import('./plugin-download.js?v=playlist116');await import('./deck-connect.js?v=playlist116');}
