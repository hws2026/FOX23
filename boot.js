import {startController} from './bridge.js?v=rails154';
const status=document.querySelector('#connection');
status.textContent='Loading browser engine…';
try{await startController();await import('./panel.js?v=rails154');await import('./pair-controller.js?v=rails154');await import('./plugin-download.js?v=rails154');await import('./deck-connect.js?v=rails154');}
