import {startController} from './bridge.js?v=lineups140';
const status=document.querySelector('#connection');
status.textContent='Loading browser engine…';
try{await startController();await import('./panel.js?v=lineups140');await import('./pair-controller.js?v=lineups140');await import('./plugin-download.js?v=lineups140');await import('./deck-connect.js?v=lineups140');}
