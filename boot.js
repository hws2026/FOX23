import {startController} from './bridge.js?v=deck2';
const status=document.querySelector('#connection');
status.textContent='Loading browser engine…';
try{await startController();await import('./panel.js?v=deck2');await import('./pair-controller.js?v=deck2');await import('./plugin-download.js?v=deck2');await import('./deck-connect.js?v=deck2');}
