import {startController} from './bridge.js?v=tunnel159';
const status=document.querySelector('#connection');
status.textContent='Loading browser engine…';
try{await startController();await import('./panel.js?v=tunnel159');await import('./pair-controller.js?v=tunnel159');await import('./plugin-download.js?v=tunnel159');await import('./deck-connect.js?v=tunnel159');}
