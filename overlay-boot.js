import {subscribe} from './bridge.js?v=location123';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=location123';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=location123');
