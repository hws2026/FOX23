import {subscribe} from './bridge.js?v=referee126';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=referee126';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=referee126');
