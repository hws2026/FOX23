import {subscribe} from './bridge.js?v=intro138';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=intro138';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=intro138');
