import {subscribe} from './bridge.js?v=rails154';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=rails154';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=rails154');
