import {subscribe} from './bridge.js?v=graphics124';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=graphics124';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=graphics124');
