import {subscribe} from './bridge.js?v=logos125';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=logos125';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=logos125');
