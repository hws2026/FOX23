import {subscribe} from './bridge.js?v=deck155';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=deck155';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=deck155');
