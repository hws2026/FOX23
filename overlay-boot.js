...
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=weather-break108';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=weather-break108');
