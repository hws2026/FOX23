import {subscribe} from './bridge.js?v=lineups140';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=lineups140';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=lineups140');
