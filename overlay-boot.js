import {subscribe} from './bridge.js?v=tunnel159';
import {renderGraphics,updateClocks,fitStage} from './graphics.js?v=tunnel159';
...
if(new URLSearchParams(location.search).has('pair'))import('./pair-output.js?v=tunnel159');
